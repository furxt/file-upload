...
public class FileUploadAutoConfiguration {
    ...
    public KeyService keyService(FileUploadProperties fileUploadProperties) {
        return new DefaultKeyServiceImpl(fileUploadProperties.getPublicKeyPath(), fileUploadProperties.getPrivateKeyPath());
    }
    ...
    public FileUploadService fileUploadService(
        ...
        return new FileUploadServiceImpl(
                fileUploadProperties.getLocalStoragePath(), fileUploadCompletedCallback, fileUploadCacheService);
    }
    ...
    @Bean
    public KeyController keyController(KeyService keyService, FileUploadCacheService fileUploadCacheService) {
